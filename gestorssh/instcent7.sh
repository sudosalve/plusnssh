...
wget https://github.com/sudosalve/plusnssh/raw/gestorssh/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://github.com/sudosalve/plusnssh/raw/gestorssh/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://github.com/sudosalve/plusnssh/raw/gestorssh/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://github.com/sudosalve/plusnssh/raw/gestorssh/uteste > /bin/usersteste.sh
wget -qO- https://github.com/sudosalve/plusnssh/raw/gestorssh/backupauto > /bin/autobackup.sh

...
sleep 5
cd /bin || exit
wget https://github.com/sudosalve/plusnssh/raw/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/sudosalve/plusnssh/raw/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/sudosalve/plusnssh/raw/gestorssh/checkuser.py > /dev/null 2>&1

...
wget github.com/sudosalve/plusnssh/raw/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget github.com/sudosalve/plusnssh/raw/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/sudosalve/plusnssh/raw/gestorssh/sincpainel.zip > /dev/null 2>&1

...
wget https://github.com/sudosalve/plusnssh/raw/ntech/gestorssh/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://github.com/sudosalve/plusnssh/raw/ntech/gestorssh/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://github.com/sudosalve/plusnssh/raw/ntech/gestorssh/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://github.com/sudosalve/plusnssh/raw/ntech/gestorssh/uteste > /bin/usersteste.sh
wget -qO- https://github.com/sudosalve/plusnssh/raw/ntech/gestorssh/backupauto > /bin/autobackup.sh

...
wget github.com/sudosalve/plusnssh/raw/ntech/gestorssh/sshplus.zip.001 > /dev/null 2>&1
wget github.com/sudosalve/plusnssh/raw/ntech/gestorssh/sshplus.zip.002 > /dev/null 2>&1
wget github.com/sudosalve/plusnssh/raw/ntech/gestorssh/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget github.com/sudosalve/plusnssh/raw/ntech/gestorssh/sincpainel.zip > /dev/null 2>&1

...
rm -rf * > /dev/null 2>&1
wget https://github.com/sudosalve/plusnssh/raw/ntech/gestorssh/gestorssharm.zip > /dev/null 2>&1
sleep 1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@GOMESNET
\033[0m"
echo ""
sleep 20
service apache2 restart > /dev/null 2>&1
